...
const ProfileInfo: FC<ProfileInfoProps> = ({
    ...
    const firstLetter = (username || profile?.user_metadata.username || 'U')
        .charAt(0)
        .toUpperCase()
        ...
        <div className={styles.profile__info}>
            ...
            >
                {currentAvatarUrl ? (
                    ...
                    <div
                        className={`${styles.profile__img} ${styles.profile__img_placeholder}`}
                    >
                        {firstLetter}
                    </div>
                )}
            ...
            <div className={styles.profile__left}>
                ...
                <div className={styles.user__date}>
                    <div className={styles.date__text}>
                        ...
                        <p className={styles.date__text__date}>
